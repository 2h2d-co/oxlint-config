...
tester.run("2h2d/no-broad-dictionary-values", noBroadDictionaryValuesRule, {
  valid: [
    ...
    "type NativeEmptyOwnsThisDiagnostic = Record<string, {}>;",
    "type NativeEmptyUnionOwnsThisDiagnostic = Record<string, string | {}>;",
    "interface NativeEmptyInterface {} type A = Record<string, NativeEmptyInterface>;",
    "type NativeEmptyAlias = {}; type A = Record<string, NativeEmptyAlias>;",
  ],
  invalid: [
